...
export type MaterialSource = "external" | "upload";
...
export type Material = { id: string; title: string; description: string; subject: string; olympiad: string | null; levels: string[]; material_type: string; objective: string; source_kind: MaterialSource | null; external_url: string | null; storage_path: string | null; status: MaterialStatus; featured: boolean; sort_order: number; created_by: string; published_at: string | null; created_at: string; updated_at: string };
export type MaterialResource = { id: string; material_id: string; title: string; resource_type: string; sort_order: number; source_kind: MaterialSource; external_url: string | null; storage_path: string | null; created_at: string };
...
export type Database = { public: { Tables: {
  ...
  materials: { Row: Material; Insert: Partial<Material> & Pick<Material, "title" | "description" | "subject" | "material_type" | "objective" | "created_by">; Update: Partial<Material>; Relationships: [] };
  material_resources: { Row: MaterialResource; Insert: Partial<MaterialResource> & Pick<MaterialResource, "material_id" | "title" | "resource_type" | "source_kind">; Update: Partial<MaterialResource>; Relationships: [] };
